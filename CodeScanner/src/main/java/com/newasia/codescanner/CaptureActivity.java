package com.newasia.codescanner;
...
import com.newasia.codescanner.decode.MainHandler;
import com.newasia.codescanner.utils.BeepManager;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image = findViewById(R.id.capture_light);
        image.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event)
            {
                ...
                if (event.getAction()==MotionEvent.ACTION_UP)
                {
                    v.setScaleX(1.0f);
                    v.setScaleY(1.0f);
                    mCameraManager.switchLightModel();
                    return  true;
                }
                return false;
            }
